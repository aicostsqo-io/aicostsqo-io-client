        ...
        <div className="w-4/5 m-auto">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Link
              href={"/signup"}
              type="submit"
              className="mt-5 border-2 border-darkBlue text-darkBlue bg-white  w-full py-2 text-center text-base hover:bg-green-500 hover:text-white transition-all duration-200 rounded"
            >
            ...
            <div className="text-right mt-5">
              <button
                type="submit"
                className={`btn text-base py-2 bg-green-500`}
              >
                Login
              </button>
            </div>
